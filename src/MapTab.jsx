  ...
  useEffect(() => {
    ...
    map.on('load', () => {
      ...
      const paintMap = {
        ...
        'road_service_case':     [['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,2,16,50]]],
        'road_minor_case':       [['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,3,16,50]]],
        'road_sec_case_noramp':  [['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,4,16,50]]],
        'road_pri_case_noramp':  [['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,5,16,50]]],
        'road_trunk_case_noramp':[['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,5,16,50]]],
        'road_mot_case_noramp':  [['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,6,16,50]]],
