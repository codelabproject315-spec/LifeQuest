  ...
  useEffect(() => {
    ...
    map.on('load', () => {
      ...
      const paintMap = {
        ...
        'road_service_fill':     [['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,1,17,30]]],
        'road_minor_fill':       [['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,2,17,30]]],
        'road_sec_fill_noramp':  [['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,3,17,30]]],
        'road_pri_fill_noramp':  [['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,4,17,30]]],
        'road_trunk_fill_noramp':[['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,4,17,30]]],
        'road_mot_fill_noramp':  [['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,5,17,30]]],
        'road_service_case':     [['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,2,17,40]]],
        'road_minor_case':       [['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,3,17,40]]],
        'road_sec_case_noramp':  [['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,4,17,40]]],
        'road_pri_case_noramp':  [['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,5,17,40]]],
        'road_trunk_case_noramp':[['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,5,17,40]]],
        'road_mot_case_noramp':  [['line-color', '#d4893a'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,6,17,40]]],
