  ...
  useEffect(() => {
    ...
    map.on('load', () => {
      ...
      const paintMap = {
        ...
        'road_service_fill':     [['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,1,17,20]]],
        'road_minor_fill':       [['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,2,17,20]]],
        'road_sec_fill_noramp':  [['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,3,17,20]]],
        'road_pri_fill_noramp':  [['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,4,17,20]]],
        'road_trunk_fill_noramp':[['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,4,17,20]]],
        'road_mot_fill_noramp':  [['line-color', '#ffffff'], ['line-width', ['interpolate',['exponential',1.5],['zoom'],10,5,17,20]]],
